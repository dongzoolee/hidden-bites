...
test("client implements the required story surfaces", async () => {
  ...
  assert.match(experience, /SelectedRestaurantDropdown/);
  assert.match(experience, /className="selected-restaurant-dropdown"/);
  assert.match(experience, /aria-haspopup="listbox"/);
  assert.match(experience, /role="listbox"/);
  assert.match(experience, /restaurants\.map\(\(restaurant, index\) =>/);
  assert.match(experience, /restaurant\.displayPlaceName/);
  assert.match(experience, /onClick=\{\(\) => handleSelect\(restaurant\.placeId\)\}/);
  assert.doesNotMatch(experience, /<span>\{selectedRestaurant\?\.placeName \?\? "Restaurant"\}<\/span>/);
  assert.match(scorePlot, /score-graph-card/);
  ...
  assert.match(reportPanel, /restaurant-explorer/);
  assert.match(reportPanel, /onExploreAnotherRestaurant/);
  ...
  assert.match(reportPanel, /report\.funnyKeywords/);
  assert.match(reportPanel, /funnyKeywordEvidence/);
  assert.doesNotMatch(reportPanel, /report\.keywords\.map|buildKeywordFooter/);
  ...
  assert.match(css, /\.selected-restaurant-dropdown__option--active,[\s\S]*\.selected-restaurant-dropdown__option\[aria-selected="true"\]\s*\{[\s\S]*background: var\(--orange\);/);
